...
public class exString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(msg.charAt(5));  //แสดงตัวอักษรตำแหน่งที่ 5
        ...
        //compare String คือ การเปรียบเทียข้อความ 2 ข้อความ
        ...
        //3. compareTo() ถ้าข้อความเหมือนเป็น 0, ข้อความทางซ้ายมากกว่าเป็น 1, ข้อความทางขวามากกว่าเป็น -1

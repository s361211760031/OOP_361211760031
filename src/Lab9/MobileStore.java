...
public class MobileStore {
    public static void main(String[] args) {
        ...
        //step 1: load driver
        try {
            Class.forName("org.sqlite.Mobile");
            System.out.println("Long drivar successfully.");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        //step 2 : Create Connection
        ArrayList<Employee> myEMP = new ArrayList<Employee>();
        String SOCONN = "jdbc:sqlite:company.sqlite";
        try {
            Connection conn = DriverManager.getConnection(SOCONN);
            if (conn == null){
